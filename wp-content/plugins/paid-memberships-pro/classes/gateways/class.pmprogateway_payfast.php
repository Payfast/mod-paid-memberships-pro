...
//                add_filter('pmpro_checkout_new_user_array', array('PMProGateway_payfast', 'pmpro_checkout_new_user_array'));
//        //        add_filter('pmpro_checkout_confirmed', array('PMProGateway_payfast', 'pmpro_checkout_confirmed'));
//        //        add_action('pmpro_checkout_before_processing', array('PMProGateway_payfast', 'pmpro_checkout_before_processing'));
//                add_filter('pmpro_checkout_default_submit_button', array('PMProGateway_payfast', 'pmpro_checkout_default_submit_button'));
//        //        add_action('pmpro_checkout_after_form', array('PMProGateway_payfast', 'pmpro_checkout_after_form'));
//            }
